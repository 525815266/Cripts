...
headers = {
    ...
    "Authorization": "Bearer 71452|4S6IwWd1bQ9gKIbce95C6Zri3v5aPVlEPzAzgxX785dedad4",
    "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 14_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.43(0x18002b22) NetType/WIFI Language/zh_CN",
...
# 检查积分是否超过1000
if reward_log is not None and reward_log["balance"] >= 100000:
    # 随机等待5-10秒模拟兑换所需时间
